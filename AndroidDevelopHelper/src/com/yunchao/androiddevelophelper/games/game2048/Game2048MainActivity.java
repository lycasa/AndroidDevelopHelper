...
public class Game2048MainActivity extends Activity implements OnClickListener {
    ...
    // Activity的引用
    private static Game2048MainActivity mGame;
     ...
     * @return
     */
    public static Game2048MainActivity getGameActivity() {
	return mGame;
    }
	...
	case R.id.btn_option:
	    Intent intent = new Intent(Game2048MainActivity.this, ConfigPreferenceActivity.class);
